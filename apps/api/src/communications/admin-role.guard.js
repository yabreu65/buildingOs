...
exports.AdminRoleGuard = exports.ADMIN_ROLES = void 0;
var common_1 = require("@nestjs/common");
/** Admin roles — mirrors ADMIN_ROLES in @buildingos/contracts */
exports.ADMIN_ROLES = ['TENANT_ADMIN', 'TENANT_OWNER', 'OPERATOR'];
/**
...
var AdminRoleGuard = function () {
    ...
    var AdminRoleGuard = _classThis = /** @class */ (function () {
        ...
        AdminRoleGuard_1.prototype.canActivate = function (context) {
            ...
            var isAdmin = userRoles.some(function (r) { return exports.ADMIN_ROLES.includes(r); });
            if (!isAdmin) {
