...
export class OnboardingService {
    ...
    return [
      {
        ...
        description: 'Registrar tu primer edificio o propiedad',
      ...
      },
      {
        ...
        description: 'Crear al menos una unidad (apartamento, oficina, etc.)',
      ...
      },
      {
        ...
        description: 'Agregar personal o administradores a tu equipo',
        status: memberCount > 1 ? 'DONE' : 'TODO',
        category: 'tenant',
      },
      {
        id: 'T4',
        label: 'Mejorar tu plan',
        description: 'Seleccionar un plan de suscripción adecuado para tus necesidades',
      ...
      },
      {
        ...
        description: 'Registrar un pedido de mantenimiento o reclamo',
      ...
      },
      {
        ...
        description: 'Compartir un anuncio con tus residentes',
  ...
  async calculateBuildingSteps(buildingId: string): Promise<BuildingOnboardingStep[]> {
    ...
    return [
      {
        id: 'B1',
        label: 'Asignar residentes a las unidades',
        description: 'Agregar ocupantes y propietarios a tus unidades',
      ...
      },
      {
        ...
        description: 'Agregar reglamentos, contratos o actas (opcional)',
      ...
      },
      {
        id: 'B3',
        label: 'Crear cargos',
        description: 'Configurar expensas comunes o cargos especiales',
        status: chargeCount > 0 ? 'DONE' : 'TODO',
        category: 'building',
      },
      {
        id: 'B4',
        label: 'Asignar proveedores de servicio',
        description: 'Agregar proveedores para mantenimiento y reparaciones',
