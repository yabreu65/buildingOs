...
const testFilePattern = /(\.spec|\.test|\.e2e-spec|-spec)\.ts$/;
...
if (findings.length > 0) {
  console.error('Focused Jest tests are forbidden in API CI. Remove these before committing:');
...
console.log(`Focused-test guard scanned ${files.length} API test files.`);
