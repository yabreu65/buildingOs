...
export type FunctionalType = 'PAYMENT_PROOF' | 'PAYMENT_RECEIPT';
...
export interface DocumentPaymentMetadata {
  ...
  /**
   * Period resolved from payment allocation.
   * Format: "YYYY-MM" when present, null when unresolvable.
   */
  period?: string | null;
}
...
export interface Document {
   ...
   * PAYMENT_PROOF: file was uploaded by resident as payment evidence.
   * PAYMENT_RECEIPT: document was generated by system as official receipt.
   * null: not linked to any payment.
   */
  functionalType?: FunctionalType | null;
  /**
   * Origin of the document content.
   * UPLOADED: file was uploaded by a user.
   * GENERATED: file was generated by BuildingOS.
   * null: not linked to any payment.
   */
  origin?: DocumentOrigin | null;
  /**
   * Financial payment metadata when linked to a Payment.
   * null when not linked.
   */
  payment?: DocumentPaymentMetadata | null;
}
