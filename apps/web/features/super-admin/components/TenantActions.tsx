      ...
      {showDeleteModal && isDemoTenant && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="w-full max-w-md rounded-xl border border-red-200 bg-card p-6 shadow-2xl">
            <h2 className="text-xl font-bold text-foreground">Eliminar demo</h2>
            <p className="mt-3 text-sm text-muted-foreground">
              Vas a borrar este tenant de prueba y todos sus datos de demo. Esta acción es irreversible.
            </p>
            <p className="mt-3 rounded-lg bg-red-50 px-3 py-2 text-sm text-red-800">
              Confirmá solo si querés limpiar datos de prueba.
            </p>
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              >
                {isDeletingDemo ? 'Eliminando demo...' : 'Sí, eliminar demo'}
              </Button>
            </div>
          </div>
        </div>
